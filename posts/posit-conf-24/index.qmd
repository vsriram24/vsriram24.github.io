...
Welcome back to another week of *\[VS\]Codes*! A few weeks ago, I had the opportunity to attend [posit::conf 2024](https://cascadiarconf.com), a national data science conference organized annually by Posit, PBC. This year, the conference was held in my home turf of Seattle, and it was an amazing experience getting to attend so many inspiring talks and meet so many members of the data science community. This blog post will summarize content from the workshop and some of the talks that I attended over the course of the conference as well as my personal overall takeaways.
